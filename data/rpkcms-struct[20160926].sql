...
INSERT INTO `page_meta` VALUES (1,9,'thumbnail','<h2>cocorico</h2>','2016-06-18 00:00:00','2016-06-17 23:24:14',1,1),(4,7,'preview','To help yourself, you must be yourself. Be the best that you can be. When you make a <strong>mistake</strong>, learn from it, pick yourself up and move on.','2016-07-26 18:59:43','2016-07-26 18:59:43',1,1);
...
--
-- Table structure for table `page_paginator`
--

DROP TABLE IF EXISTS `page_paginator`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `page_paginator` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pageId` int(11) NOT NULL,
  `listTemplateId` int(11) NOT NULL COMMENT 'the template id that will be used to generate sub lists',
  `name` varchar(255) NOT NULL,
  `itemsNumber` int(11) NOT NULL DEFAULT '20',
  ...
  `state` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `templateId` (`pageId`),
  KEY `listTemplateId` (`listTemplateId`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `page_paginator`
--

LOCK TABLES `page_paginator` WRITE;
/*!40000 ALTER TABLE `page_paginator` DISABLE KEYS */;
INSERT INTO `page_paginator` VALUES (1,18,2,'page',121,'pages.creationdate','asc','0000-00-00 00:00:00','2016-09-18 11:41:22',1,1),(2,30,13,'delete-list',7,'pages.creationdate','desc','0000-00-00 00:00:00','2016-09-22 19:09:46',1,1),(3,11,13,'mistakes',21,'pages.creationdate','desc','0000-00-00 00:00:00','2016-09-24 09:26:30',1,1);
/*!40000 ALTER TABLE `page_paginator` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `pages_4test`
--

LOCK TABLES `pages_4test` WRITE;
/*!40000 ALTER TABLE `pages_4test` DISABLE KEYS */;
INSERT INTO `pages_4test` VALUES (1,4,0,0,0,'test','test description','<p>test page</p>','testa','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(2,4,0,0,0,'test','test description','<p>test page</p>','testb','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(3,4,0,0,0,'test','test description','<p>test page</p>','testc','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(4,4,0,0,0,'test','test description','<p>test page</p>','testd','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(5,4,0,0,0,'test','test description','<p>test page</p>','teste','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(6,4,0,0,0,'test','test description','<p>test page</p>','testf','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(7,4,0,0,0,'test','test description','<p>test page</p>','testg','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(8,4,0,0,0,'test','test description','<p>test page</p>','testh','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(9,4,0,0,0,'test','test description','<p>test page</p>','testi','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(10,4,0,0,0,'test','test description','<p>test page</p>','testj','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(11,4,0,0,0,'test','test description','<p>test page</p>','testk','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(12,4,0,0,0,'test','test description','<p>test page</p>','testl','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(13,4,0,0,0,'test','test description','<p>test page</p>','testm','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(14,4,0,0,0,'test','test description','<p>test page</p>','testn','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(15,4,0,0,0,'test','test description','<p>test page</p>','testo','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(16,4,0,0,0,'test','test description','<p>test page</p>','testp','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(17,4,0,0,0,'test','test description','<p>test page</p>','testq','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(18,12,0,0,2,'test','test description','<p>test page with paginator active</p>','testr','2016-11-07 00:00:00','2016-09-18 11:35:37',0,0,1,1),(19,4,0,0,0,'test','test description','<p>test page</p>','tests','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(20,4,0,0,0,'test','test description','<p>test page</p>','testt','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(21,4,0,0,0,'test','test description','<p>test page</p>','testu','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(22,4,0,0,0,'test','test description','<p>test page</p>','testv','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(23,4,0,0,0,'test','test description','<p>test page</p>','testw','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(24,4,0,0,0,'test','test description','<p>test page</p>','testx','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(25,4,0,0,0,'test','test description','<p>test page</p>','testy','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(26,4,0,0,0,'test','test description','<p>test page</p>','testz','2016-04-07 00:00:00','2016-09-15 19:34:30',0,0,1,1),(27,2,0,0,2,'to be deleted','test page for paginator','<p>test content</p>','tobedeleted','2016-09-20 00:00:00','2016-09-22 19:08:19',0,1,1,1),(29,2,0,0,2,'to be deleted','test page for paginator','<p><br></p>','tobedeleteddoi','2016-09-21 00:00:00','2016-09-22 19:08:12',0,1,1,1),(30,12,0,1,2,'to be deleted 2 10','test page for paginator','<p>lorem ipsum el dolor</p>','tobedeleteddoizece','2016-09-22 00:00:00','2016-09-22 19:08:05',0,1,1,1);
/*!40000 ALTER TABLE `pages_4test` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-09-26 18:49:21
